...
namespace Sirenix.OdinInspector
{
    ...
    {
        /// <summary>The message shown in the tooltip.</summary>
        public string Tooltip;

        /// <summary>Adds a tooltip to the property in the inspector.</summary>
        /// <param name="tooltip">The message shown in the tooltip.</param>
        public PropertyTooltipAttribute(string tooltip) => this.Tooltip = tooltip;
    }
